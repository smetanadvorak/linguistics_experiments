...
from eyeoi.babibo.babibo_experiment import get_item_order
...
def main():
    ...
    for id in tqdm(dataset.data):
        ...
        video_path = dataset.get_path(id, "video")
        n_skip = 0 if "P2" in video_path else 6
        detected_events = matcher.find_events_cross(dataset.get_path(id, "video"), item_order, n_skip, True, True)
...
"""
python3 find_events_cross.py data_example
"""